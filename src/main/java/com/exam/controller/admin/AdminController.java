...
public class AdminController {
	...
	public String loginJson(HttpServletRequest request, Users users) {
		HttpSession session = request.getSession();
		String sessionCode = ((String) request.getSession().getAttribute("code")).toUpperCase();// session中验证码
		String code = users.getCode().toUpperCase();// 用户code
