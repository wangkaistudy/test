...
public class QuestionBankServiceImpl implements QuestionBankService {
	...
	public PageInfo<QuestionBankVo> findAllQuestionBank(PageInfo<QuestionBankVo> pageInfo) {
		...
		List<QuestionBankVo> AllQuestionBank = questionBankMapper.findAllQuestionBank_new();
		for (QuestionBankVo qbv:AllQuestionBank
			 ) {
			qbv.setOptions(questionBankMapper.findAllOptions(qbv.getQuestionBankId()));
		}
